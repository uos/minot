...
function(r2r_cargo)
  ...
  add_custom_target(cargo_target ALL
      COMMAND ${CMAKE_COMMAND} "-E" "env" "RUSTFLAGS=$ENV{RUSTFLAGS}" "CMAKE_IDL_PACKAGES=$ENV{CMAKE_IDL_PACKAGES}" "CMAKE_INCLUDE_DIRS=$ENV{CMAKE_INCLUDE_DIRS}" "cargo" "build" "-p" "minot" "--profile" "colcon" "--no-default-features" "--features" "${FEATURES_STR}" "--locked"
