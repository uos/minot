...
pub fn render(app: &mut App, frame: &mut Frame) {
    match app.mode {
        crate::app::Mode::Wind { hide_compare: true } => {
            let block = Block::new()
                .title_bottom(Line::from(app.render_var_locked()).left_aligned())
        ...
        | crate::app::Mode::Compare => {
            ...
            frame.render_stateful_widget(
                Scrollbar::default()
                    ...
                    .thumb_symbol(ratatui::symbols::block::FULL)
